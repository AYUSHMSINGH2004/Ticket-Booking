...
export default function Login() {
  const [email, setEmail] = useState('customer@unthinkable.co');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.location.href = '/'; // Hard reload to get new navbar state
    } catch (err: any) {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="glass-panel p-12 rounded-3xl w-full max-w-md">
        ...
        <p className="text-gray-400 text-center mb-8">Sign in to book your tickets</p>
